...
New-AzureRMResourceGroupDeployment -ResourceGroupName $rgnamemel -TemplateFile .\contosoObjects.json -TemplateParameterObject $MELParams -Verbose
New-AzureRMResourceGroupDeployment -ResourceGroupName $rgnamesyd -TemplateFile .\contosoObjects.json -TemplateParameterObject $SYDParams -Verbose 
